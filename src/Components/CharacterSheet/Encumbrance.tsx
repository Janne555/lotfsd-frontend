...
import { calculateEncumbranceDetails } from '../../services'
...
export default function Encumbrance({ encumbrance }: Props): JSX.Element {
  const classes = useStyles()
  const { combatDistance, dayDistance, explorationDistance, description } = calculateEncumbranceDetails(encumbrance)
